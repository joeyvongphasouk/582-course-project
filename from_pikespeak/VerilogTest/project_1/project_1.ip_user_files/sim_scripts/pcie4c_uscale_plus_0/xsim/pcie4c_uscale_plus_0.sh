...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L gtwizard_ultrascale_v1_7_19 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pcie4c_uscale_plus_0 xil_defaultlib.pcie4c_uscale_plus_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pcie4c_uscale_plus_0 -key {Behavioral:sim_1:Functional:pcie4c_uscale_plus_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pcie4c_uscale_plus_0.wdb xsim.dir libdpi.so)
