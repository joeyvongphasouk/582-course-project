...
design_libs=(xpm gtwizard_ultrascale_v1_7_19 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../pcie4c_uscale_plus_0_ex.gen/sources_1/ip/pcie4c_uscale_plus_0/source" \
  ...
  vlogan -work gtwizard_ultrascale_v1_7_19 $vlogan_opts +v2k +incdir+"../../../../pcie4c_uscale_plus_0_ex.gen/sources_1/ip/pcie4c_uscale_plus_0/source" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../pcie4c_uscale_plus_0_ex.gen/sources_1/ip/pcie4c_uscale_plus_0/source" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pcie4c_uscale_plus_0 xil_defaultlib.glbl -o pcie4c_uscale_plus_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pcie4c_uscale_plus_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pcie4c_uscale_plus_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pcie4c_uscale_plus_0_simv.daidir vcs_lib c.obj)
