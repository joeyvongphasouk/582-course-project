...
#
# Script generated by Vivado on Thu Apr 17 08:09:49 MDT 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pcie4c_uscale_plus_0.sh
...
#
# Usage        : pcie4c_uscale_plus_0.sh
#                pcie4c_uscale_plus_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pcie4c_uscale_plus_0.sh [-reset_run]
#                pcie4c_uscale_plus_0.sh [-reset_log]
#                pcie4c_uscale_plus_0.sh [-help]
#
...
#                script (type 'pcie4c_uscale_plus_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname gtwizard_ultrascale_v1_7_19 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm gtwizard_ultrascale_v1_7_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "pcie4c_uscale_plus_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pcie4c_uscale_plus_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../pcie4c_uscale_plus_0_ex.gen/sources_1/ip/pcie4c_uscale_plus_0/source" \
  ...
  xmvlog -work gtwizard_ultrascale_v1_7_19 $xmvlog_opts +incdir+"../../../../pcie4c_uscale_plus_0_ex.gen/sources_1/ip/pcie4c_uscale_plus_0/source" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../pcie4c_uscale_plus_0_ex.gen/sources_1/ip/pcie4c_uscale_plus_0/source" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.pcie4c_uscale_plus_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.pcie4c_uscale_plus_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log pcie4c_uscale_plus_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pcie4c_uscale_plus_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pcie4c_uscale_plus_0.sh [-help]\n\
Usage: pcie4c_uscale_plus_0.sh [-step]\n\
Usage: pcie4c_uscale_plus_0.sh [-lib_map_path]\n\
Usage: pcie4c_uscale_plus_0.sh [-reset_run]\n\
Usage: pcie4c_uscale_plus_0.sh [-reset_log]\n\
Usage: pcie4c_uscale_plus_0.sh [-keep_index]\n\
Usage: pcie4c_uscale_plus_0.sh [-noclean_files]\n\n\
