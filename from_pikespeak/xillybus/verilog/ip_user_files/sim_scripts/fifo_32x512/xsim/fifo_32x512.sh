...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L fifo_generator_v13_2_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_32x512 xil_defaultlib.fifo_32x512 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_32x512.wdb xsim.dir libdpi.so)
