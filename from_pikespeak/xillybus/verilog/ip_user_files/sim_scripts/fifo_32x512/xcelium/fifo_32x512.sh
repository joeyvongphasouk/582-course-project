...
#
# Script generated by Vivado on Sun Apr 27 09:12:46 MDT 2025
...
#
# Usage        : fifo_32x512.sh
#                fifo_32x512.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_32x512.sh [-reset_run]
#                fifo_32x512.sh [-reset_log]
#                fifo_32x512.sh [-help]
#
...
#                script (type 'fifo_32x512.sh -help' for more information).
#
...
# script info
echo -e "fifo_32x512.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_32x512.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_32x512 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_32x512 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_32x512_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fifo_32x512.sh [-step]\n\
Usage: fifo_32x512.sh [-lib_map_path]\n\
Usage: fifo_32x512.sh [-reset_run]\n\
Usage: fifo_32x512.sh [-reset_log]\n\
Usage: fifo_32x512.sh [-keep_index]\n\
