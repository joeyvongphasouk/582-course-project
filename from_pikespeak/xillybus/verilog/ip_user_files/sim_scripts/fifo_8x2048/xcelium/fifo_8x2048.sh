...
#
# Script generated by Vivado on Sun Apr 27 08:46:06 MDT 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_8x2048.sh
...
#
# Usage        : fifo_8x2048.sh
#                fifo_8x2048.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_8x2048.sh [-reset_run]
#                fifo_8x2048.sh [-reset_log]
#                fifo_8x2048.sh [-help]
#
...
#                script (type 'fifo_8x2048.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname fifo_generator_v13_2_11 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm fifo_generator_v13_2_11 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fifo_8x2048.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_8x2048.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work fifo_generator_v13_2_11 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_8x2048 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_8x2048 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_8x2048_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_8x2048.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_8x2048.sh [-help]\n\
Usage: fifo_8x2048.sh [-step]\n\
Usage: fifo_8x2048.sh [-lib_map_path]\n\
Usage: fifo_8x2048.sh [-reset_run]\n\
Usage: fifo_8x2048.sh [-reset_log]\n\
Usage: fifo_8x2048.sh [-keep_index]\n\
Usage: fifo_8x2048.sh [-noclean_files]\n\n\
