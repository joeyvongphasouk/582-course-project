...
HD_PWD='/home/hkchu/xillybus/verilog/vivado/xillydemo.runs/pcie4c_uscale_plus_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pcie4c_uscale_plus_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pcie4c_uscale_plus_0.tcl
