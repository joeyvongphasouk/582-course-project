...
def extend_file_to_size(file_path, target_size, unit):
    unit_multipliers = {
        "KB": 1024,
        "MB": 1024 * 1024,
        "GB": 1024 * 1024 * 1024,
...
def main():
    if len(sys.argv) != 4:
        print("incorrect usage, python3 extend_input.py <input file> <size> <B|KB|MB|GB>")
    extend_file_to_size(sys.argv[1], sys.argv[2], sys.argv[3])
